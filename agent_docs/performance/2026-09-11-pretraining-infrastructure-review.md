...
- **The 131.8k evaluation was voided too, and the rounds are getting slower.** Evaluation seconds ran
  ...
  went the same way, so 12 of 24 rounds have measured nothing, seven of the last eight, and
  3.0 GPU-hours went into rounds that measured nothing. The evaluation signal is
