...
| Record | Status | Scope |
|---|---|---|
| [Dressing actor-action audit](2026-09-17-dressing-actor-audit.md) | Diagnostic observation/controller corrections tested; native bounded audit in progress | Current-action six-frame guidance versus executed finite differences and grasp-preserving coverage improvements |
