...
| [0008](0008-ipc-adjoint-q-learning.md) | Proposed | Pair soft Bellman values and IPC action derivatives; validate replay freshness and contact-conditioned trust on small tasks |
